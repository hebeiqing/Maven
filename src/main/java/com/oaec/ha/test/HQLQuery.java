...
public class HQLQuery {
    ...
    public void findCourseByCondition(){
        ...
        query.setParameter(1, "%a%").setParameter(2, "计算机");  //多条件查询 ，setParameter设置参数
        List<Course> courseList = query.getResultList();
        //当getResultList()查询不到结果时，则抛出entity not fonud 而不是返回null
    ...
    public void findByPage(){
        ...
        query.setFirstResult(0);  //设置分页 ，从0开始
        query.setMaxResults(2); //每次返回两条结果集
